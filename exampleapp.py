...
def fbapi_app_token(id):
	token=fbapi_get_string(path="/oauth/access_token",params={'grant_type':'client_credentials','client_id':id,'client_secret':app.config['FB_APP_SECRET'],'redirect_uri':urllib.urlencode(get_home())})
	return token
